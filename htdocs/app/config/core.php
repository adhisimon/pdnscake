 ...
 *
 * WARNING:
 * Don't put your configuration here, please use "core.local.php"
 * instead. You can create "core.local.php" from a scratch or copy
 * "core.local.sample.php" to "core.local.php".
 *
 * Any configuration you put here would override by update process.
 */
